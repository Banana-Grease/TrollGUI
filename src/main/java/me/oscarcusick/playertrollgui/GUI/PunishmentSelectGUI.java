...
public class PunishmentSelectGUI {
    ...
    public void OpenGUI() {
        ...
        GUIButtonLore.set(0, ChatColor.DARK_PURPLE + "Freezes The Target Player Client"); // Freeze the client
        GUIButtonLore.set(1, ChatColor.DARK_PURPLE + "Only Attacks The Intended Target");
        PunishmentSelectGUI.setItem(6+9*2, GUtil.GenerateGUIButton(Material.BLUE_ICE,ChatColor.GOLD + "Freeze & Crash Client", GUIButtonLore));

        GUIButtonLore.set(0, ChatColor.DARK_PURPLE + "Spawns A Zombie Only The Target Can See"); // Phantom Zombie
        GUIButtonLore.set(1, ChatColor.DARK_PURPLE + "Should Behave And Damage Like A Regular Mob");
        PunishmentSelectGUI.setItem(7+9*2, GUtil.GenerateGUIButton(Material.ZOMBIE_HEAD,ChatColor.GOLD + "Phantom Zombie", GUIButtonLore));
